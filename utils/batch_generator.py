...
def getDatasetChunk(split):
    ...
    for i in range(0, len(split), cfg.BATCH_SIZE): #changed from xrange to range for version python3
...
def threadedGenerator(generator, num_cached=32):
    ...
    import queue as Queue# changed from Queue to queue for python3
