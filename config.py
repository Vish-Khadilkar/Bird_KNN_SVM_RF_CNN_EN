...
#TRAINSET_PATH = '/mnt/mydisk/TrainingSet/'
TRAINSET_PATH = '/mnt/mydisk/Bird_Sound_Data_Zip/BirdCLEF2017TrainingSetPart1/TrainingSet/'
...
#TESTSET_PATH = os.path.join(TRAINSET_PATH, 'BirdCLEF2018MonophoneTest')
TESTSET_PATH = os.path.join(TRAINSET_PATH, 'val') # changed above path to pint to val directory
...
TEST_MODELS = ['BirdCLEF_TUC_CLO_EXAMPLE_model_epoch_2.pkl']
